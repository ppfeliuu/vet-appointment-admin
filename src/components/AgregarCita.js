...
const AgregarCita = () => {
    ...
    return (
        ...
        <div className="card-body">
            ...
            <form onSubmit={subimitNuevaCita}>
            ...
            {error.error ? <div className="alert alert-danger text-center p2">Todos los campos son obligartorios</div> : null}           
        </div>
</div>
    )
}
